...
final class DisplaySyncCoordinator: @unchecked Sendable {
    ...
    private var displayRetryWorkItem: DispatchWorkItem?
    ...
    private func startFollowingUnlocked() {
        ...
        nitsReader.startPolling { [weak self] nits in
            guard let self, activeGeneration == self.generation, self.phase == .syncing else {
                return
            }
    ...
    private func startCalibrationObservationUnlocked() {
        ...
        nitsReader.startPolling { [weak self] nits in
            guard let self,
                  ...
                  self.calibration != nil,
                  case .calibrating = self.phase else { return }
